        ...
        if ($isTargetCDisk) {
            ...
            if ($usingWipe) {
                ...
                if ($hasFreeSpace) {
                    ...
                    # No free space, no shrinkable, and wipe not selected/possible
    ...
    $confirmButton.Add_Click({
        ...
        if (-not $selDisk.IsCDisk) {
            ...
            if ($strat -eq "other_drive") {
                ...
                # Double-confirmation for destructive wipe
...
"@
            ...
            # Initialize as GPT if not already
            try {
            ...
            # Remaining space is left unallocated for the Linux installer
            Start-Sleep -Seconds 2
