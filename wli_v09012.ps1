...
# Distributions: Linux Mint 22.3 "Zena" (Cinnamon Edition), Ubuntu 24.04.4 LTS
...
$subHeaderLabel.Text = "Linux Mint 22.3, Ubuntu 24.04.4 LTS, or Debian Live 13.3.0 KDE  |  Installs directly from Windows - no USB required"
...
$isoGroup.Size = New-Object System.Drawing.Size(680, 125)
...
$distroPanel.Size = New-Object System.Drawing.Size(650, 74)
...
$debianRadio.Location = New-Object System.Drawing.Point(0, 48)
...
$customRadio.Location = New-Object System.Drawing.Point(10, 93)
...
$customIsoTextbox.Location = New-Object System.Drawing.Point(172, 91)
...
$browseButton.Location = New-Object System.Drawing.Point(568, 90)
...
$diskGroup.Location = New-Object System.Drawing.Point(10, 239)
...
$sizeGroup.Location = New-Object System.Drawing.Point(360, 239)
...
$logGroup.Location = New-Object System.Drawing.Point(10, 378)
...
$deleteIsoCheck.Location = New-Object System.Drawing.Point(10, 608)
...
$autoRestartCheck.Location = New-Object System.Drawing.Point(10, 633)
...
$startButton.Location = New-Object System.Drawing.Point(390, 608)
...
$exitButton.Location = New-Object System.Drawing.Point(540, 608)
...
function Verify-ISOChecksum {
    ...
    try {
        $expectedHash = if ($ubuntuRadio.Checked) { $script:UbuntuChecksum } elseif ($debianRadio.Checked) { $script:DebianChecksum } else { $script:ExpectedChecksum }
...
function Start-Installation {
    ...
    $distroName = if ($ubuntuRadio.Checked) { "Ubuntu 24.04.4 LTS" } elseif ($debianRadio.Checked) { "Debian Live 13.3.0 KDE" } else { "Linux Mint 22.3" }
                ...
                try {
                    ...
                    if ($fileInfo.Length -lt 2GB) {
                        ...
                        if (-not (Verify-ISOChecksum -FilePath $script:IsoPath)) {
                            ...
                            # Debian Live uses a hybrid ISO format that Windows cannot mount via
                            # Get-DiskImage. Since the checksum already confirmed file integrity,
                            # skip the mount test for Debian to avoid a false-positive error.
                            if (-not $debianRadio.Checked) {
                                try {
                                ...
                                Log-Message "ISO mount test skipped (Debian hybrid ISO format)"
                            }
                        }
                    }
                }
...
"@
        ...
        try {
            ...
            if (-not $customRadio.Checked) {
                # Debian Live stores the kernel under /live/, Ubuntu/Mint use /casper/
