...
Download ulli-linux-v090146.py, right click on ulli-linux-v090146.py, click properties, and then, under the permissions tab check "Allow this file to run as a program". Then double click on the .py and click "Run in Terminal"
