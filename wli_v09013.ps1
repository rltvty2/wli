...
# Distributions: Linux Mint 22.3 "Zena" (Cinnamon Edition), Ubuntu 24.04.4 LTS, Debian Live 13.3.0 KDE, Fedora 43 KDE
...
$form.Size = New-Object System.Drawing.Size(720, 740)
...
$subHeaderLabel.Text = "Mint 22.3, Ubuntu 24.04.4, Debian 13.3.0, or Fedora 43 KDE  |  Installs directly from Windows - no USB required"
...
$isoGroup.Size = New-Object System.Drawing.Size(680, 150)
...
$distroPanel.Size = New-Object System.Drawing.Size(650, 98)
...
$fedoraRadio.Location = New-Object System.Drawing.Point(0, 72)
...
$customRadio.Location = New-Object System.Drawing.Point(10, 118)
...
$customIsoTextbox.Location = New-Object System.Drawing.Point(172, 116)
...
$browseButton.Location = New-Object System.Drawing.Point(568, 115)
...
$diskGroup.Location = New-Object System.Drawing.Point(10, 264)
...
$sizeGroup.Location = New-Object System.Drawing.Point(360, 264)
...
$logGroup.Location = New-Object System.Drawing.Point(10, 403)
...
$deleteIsoCheck.Location = New-Object System.Drawing.Point(10, 633)
...
$autoRestartCheck.Location = New-Object System.Drawing.Point(10, 658)
...
$startButton.Location = New-Object System.Drawing.Point(390, 638)
...
$exitButton.Location = New-Object System.Drawing.Point(540, 638)
...
function Verify-ISOChecksum {
    ...
    try {
        $expectedHash = if ($ubuntuRadio.Checked) { $script:UbuntuChecksum } elseif ($debianRadio.Checked) { $script:DebianChecksum } elseif ($fedoraRadio.Checked) { $script:FedoraChecksum } else { $script:ExpectedChecksum }
...
function Start-Installation {
    ...
    $distroName = if ($ubuntuRadio.Checked) { "Ubuntu 24.04.4 LTS" } elseif ($debianRadio.Checked) { "Debian Live 13.3.0 KDE" } elseif ($fedoraRadio.Checked) { "Fedora 43 KDE" } else { "Linux Mint 22.3" }
