...
$form.Size = New-Object System.Drawing.Size(720, 690)
...
$subHeaderLabel.Text = "Linux Mint 22.3 or Ubuntu 24.04.4 LTS  |  Installs directly from Windows - no USB required"
...
$isoGroup.Size = New-Object System.Drawing.Size(680, 105)
...
$distroPanel.Size = New-Object System.Drawing.Size(650, 50)
...
$customRadio.Location = New-Object System.Drawing.Point(10, 73)
...
$customIsoTextbox.Location = New-Object System.Drawing.Point(172, 71)
...
$browseButton.Location = New-Object System.Drawing.Point(568, 70)
...
$diskGroup.Location = New-Object System.Drawing.Point(10, 219)
...
$sizeGroup.Location = New-Object System.Drawing.Point(360, 219)
...
$logGroup.Location = New-Object System.Drawing.Point(10, 358)
...
$deleteIsoCheck.Location = New-Object System.Drawing.Point(10, 588)
...
$autoRestartCheck.Location = New-Object System.Drawing.Point(10, 613)
...
$startButton.Location = New-Object System.Drawing.Point(390, 588)
...
$exitButton.Location = New-Object System.Drawing.Point(540, 588)
...
function Verify-ISOChecksum {
    ...
    try {
        $expectedHash = if ($ubuntuRadio.Checked) { $script:UbuntuChecksum } else { $script:ExpectedChecksum }
...
function Start-Installation {
    ...
    $distroName = if ($ubuntuRadio.Checked) { "Ubuntu 24.04.4 LTS" } else { "Linux Mint 22.3" }
